        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel pane-default">
                    ...
                    @endif
                       <form class="form-hoizontal" wire:submit.prevet="storeCategory">
                            <div class="form-group">
                                <label for="category_name control-label" class="col-md-4 control-label">Category Name</label>
                            
                                <input id="category_name" type="text" placeholder="Category"  class="form-control input-md" wire:model="name" wire:keyup="generateslug">
                            </div>
