	...
	<main id="main" class="main-site">
		...
		<div class="container">
			...
			<div class="wrap-breadcrumb">
				<ul>
					<li class="item-link"><a href="/{{lang}}" class="link">{{__('lang.home')}}</a></li>
					<li class="item-link"><span>{{__('lang.detail')}}</span></li>
				</ul>
			</div>
			...
			<div class="row">
					...
					<div class="wrap-product-detail">
						...
						<div class="detail-info">
							...
							<div class="wrap-butons">
								<a href="#" class="btn add-to-cart"  wire:click.prevent="store({{$product->id}}, '{{$product->name}}', {{$product->regular_price}})" >{{__('lang.AddtoCart')}}</a>
                                <div class="wrap-btn">
				...
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
					...
					<div class="widget mercado-widget widget-product">
						<h2 class="widget-title">{{__('lang.Po')}}</h2>
						<div class="widget-content">
							<ul class="products">
