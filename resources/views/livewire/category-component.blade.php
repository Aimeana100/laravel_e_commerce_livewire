    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span></span>{{$category_name}}</li>
            </ul>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                ...
                <!-- Categories widget-->
                {{-- brand to be programmed in future --}}
                ...
                <div class="widget mercado-widget filter-widget">
                    ...
                    <div class="widget-content">
                        <ul class="list-style vertical-list has-count-index">
                            ...
                            <li class="list-item"><a class="filter-link " href="#">pink <span>(179)</span></a></li>
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area float-left">
